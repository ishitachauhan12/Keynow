    ...
    <div id="wrapper">
      ...
      >
        <div className="container-fluid d-flex flex-column p-0">
          ...
          {/*<ul className="navbar-nav text-light" id="accordionSidebar">
            ...
            <li className="nav-item"></li>
            <li className="nav-item">
              <a className="nav-link active" href="auth.html">
      ...
      <div className="d-flex flex-column" id="content-wrapper">
        <div id="content">
          ...
          <div className="container-fluid">
            <h3 className="text-dark mb-1">Login/Sign up</h3>
          </div>
            ...
            <form>
              ...
              <div className="mb-3">
                ...
                >
                  ...
                  <a href="/authen/sign-in" style={{color:"white"}}>Log In</a>
                </button>
                <button
                  className="btn btn-primary d-block w-100"
                  type="submit"
                ...
                >
                <a href="/authen/sign-up" style={{color:"white"}}>Sign up</a>
                </button>
              </div>
            </form>
          </section>
